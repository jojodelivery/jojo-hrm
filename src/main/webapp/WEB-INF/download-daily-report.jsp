...
<div class="container">
	<div class="row">
		<h2 align="center" class="toptext">Download Daily Payment Report</h2>
	</div>
</div>
...
<div class="container">
	<div class="row">
		...
		<form name="downloadDailyReport" id="downloadDailyReport" method="post" action="downloadDailyReport" autocomplete="off"
			role="form">
...
function getStation(){
	...
	$('#downloadDailyReport').submit(function(e) {
		var frm = $('#downloadDailyReport');
		e.preventDefault();
		
		var url = 'report/daily/' + $("#station").val()+'/'+$("#txnMonth").val()+'/'+$("#txnYear").val();
		$.ajax({
			contentType : 'application/json; charset=utf-8',
			url : url,
			type : "GET",
